...
CREATE TABLE IF NOT EXISTS `db_events`.`tbl_subscription` (
  `subscription_number` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `subscribed_user_id` INT(10) UNSIGNED NOT NULL,
  `indication_user_id` INT(10) UNSIGNED NULL DEFAULT NULL,
